...
# Autoscript Tunneling untuk Debian 11/12 dan Ubuntu 22/24
# Script untuk instalasi dan konfigurasi OpenSSH dan Dropbear
...
install_packages() {
    ...
    local packages="openssh-server dropbear-bin net-tools"
...
# Script untuk uninstall autoscript tunnel
echo "Menghapus konfigurasi tunnel..."

# Stop services
systemctl stop ssh dropbear
...
main() {
    clear
    echo "=============================================="
    echo "    AUTOSCRIPT TUNNELING INSTALLER"
